...
program
    ...
    .option("-b, --editor-bundle <path>", "path to the project bundle, usually generated by building the project with the Wonderland Engine editor\r", "cache/js/_editor_bundle.cjs")
